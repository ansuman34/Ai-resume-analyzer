      ...
      <div className="content-wrapper">
        ...
        >
          <div className="auth-header">
            ...
            <p>Sign up to get started with ResuMax</p>
          </div>
          ...
          <div className="social-auth">
            <button className="btn-social" type="button" onClick={handleGoogleAuth}>
            ...
            <button className="btn-social" type="button" onClick={handleGithubAuth}>
              <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
